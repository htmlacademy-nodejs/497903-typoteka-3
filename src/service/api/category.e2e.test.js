...
const mockData = [
  ...
  },
  {
    ...
    comments: [
      ...
      { user: `ivanov@example.com`, text: "Согласен с автором!", id: "jHTbUN" },
      {
        user: `petrov@example.com`,
        text: "Совсем немного...Хочу такую же футболку :-)",
        id: "IdUTZp",
      },
      { user: `ivanov@example.com`, text: "", id: "HNLRw8" },
      {
        user: `petrov@example.com`,
  ...
  },
  {
    ...
    comments: [
      { user: `petrov@example.com`, text: "Совсем немного...", id: "lBens6" },
      {
        user: `ivanov@example.com`,
        text: "Мне не нравится ваш стиль. Ощущение, что вы меня поучаете.Это где ж такие красоты?",
        id: "3bUXoo",
      },
      { user: `petrov@example.com`, text: "Совсем немного...", id: "3PR_-a" },
      {
        user: `ivanov@example.com`,
  ...
  },
  {
    ...
    comments: [
      {
        user: `petrov@example.com`,
        text: "Совсем немного...Хочу такую же футболку :-)Планируете записать видосик на эту тему?",
        id: "MI6YY_",
      },
      {
        user: `ivanov@example.com`,
...
describe(`API returns category list`, () => {
  ...
  test(`Category names are
    ...
    expect(response.body).toEqual(
      expect.arrayContaining([`Еда`, `Кино`, `Музыка`])
    ));
});
